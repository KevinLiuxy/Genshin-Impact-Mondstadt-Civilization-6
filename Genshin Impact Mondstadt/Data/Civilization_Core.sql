...
VALUES	('CIVILIZATION_GENSHIN_MONDSTADT',	'TRAIT_CIVILIZATION_CITY_OF_WIND_AND_IDYLL'			),
		...
		('CIVILIZATION_GENSHIN_MONDSTADT',	'TRAIT_GENSHIN_IMPROVEMENT_ADVENTURERS_GUILD'		);
...
VALUES	('MOMENT_ILLUSTRATION_UNIQUE_UNIT',		'MOMENT_DATA_UNIT',		'UNIT_OUTRIDER',					'MOMENT_OUTRIDER'				),
		('MOMENT_ILLUSTRATION_UNIQUE_DISTRICT',	'MOMENT_DATA_DISTRICT',	'DISTRICT_FAVONIUS_HEADQUARTER',	'MOMENT_FAVONIUS_HEADQUARTER'	);
